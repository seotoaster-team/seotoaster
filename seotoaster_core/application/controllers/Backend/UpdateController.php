...
class Backend_UpdateController extends Zend_Controller_Action {
    ...
    const MASTER_CMS_LINK = 'http://seotoaster.loc/cms.txt';
    const MASTER_STORE_LINK = 'http://seotoaster.loc/store.txt';
    ...
    public function updateAction(){
        ...
        try {
            if ( Tools_Filesystem_Tools::getFile( $this->_websitePath . 'plugins/shopping/version.txt') ) {
