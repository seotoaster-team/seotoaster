...
function(a){},{classname:"warning"}),!1;showDelConfirm()}):showDelConfirm()});$("#search-reindex").on("click",reindexCall)});
function reindexCall(){$.ajax({url:$("#website_url").val()+"api/toaster/searchreindex/",method:"POST",data:JSON.stringify({}),dataType:"json",beforeSend:function(){showMessage("Indexing...",!1)},success:function(a){hideSpinner();a.error?showMessage(a.responseText,!0):(showMessage("Reindexed "+a.responseText.indexedPages+" pages",!1,1E3),a.responseText["final"]||reindexCall())},error:function(a){showMessage("Something went wrong, please try again.",!0)}})}
function showDelConfirm(){var a=$("#del-page-id").val(),b=$("#website_url").val();smoke.confirm("Are you sure you want to delete this page?",function(c){c&&$.ajax({url:b+"backend/backend_page/delete/id/"+a,type:"DELETE",dataType:"json",beforeSend:function(){smoke.signal("Removing page...",3E4)},success:function(a){hideSpinner();a.error?smoke.alert(a.responseText.body,{classname:"error"}):top.location.href=b}})},{classname:"error",ok:"Yes",cancel:"No"})};
