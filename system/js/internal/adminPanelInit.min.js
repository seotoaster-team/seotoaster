...
JSON.parse(b.responseText);200==b.status?setTimeout(function(){a.target.classList.remove("run");showMessage(c.responseText,!1,2500)},2E3):setTimeout(function(){a.target.classList.remove("run");showMessage(c.responseText,!0)},2E3)})})();
