$(function(){$(document).on("click","#widgets-shortcodes",function(a){window.open($(a.target).data("externalUrl")+"cheat-sheet.html","_blank")});null==$.cookie("hideAdminPanel")&&$.cookie("hideAdminPanel",0);$.cookie("hideAdminPanel")&&1==$.cookie("hideAdminPanel")&&($("#cpanelul").hide(),$("#logoutul").hide(),$("#seotoaster-logowrap").hide(),$("#showhide > a").text("Expand menu"));$("#cpanelul").accordion({heightStyle:"content",icons:null});$.cookie("currSectionOpen")&&$("#cpanelul").accordion({active:parseInt($.cookie("currSectionOpen")),
icons:null});$(document).on("click","#cpanelul li",function(){$.cookie("currSectionOpen",$(this).index())});$("#showhide > a").click(function(){$.cookie("hideAdminPanel",1==$.cookie("hideAdminPanel")?0:1);$(this).text(1==$.cookie("hideAdminPanel")?"Expand menu":"Collapse menu");$("#cpanelul").slideToggle();$("#logoutul").toggle();$("#seotoaster-logowrap").slideToggle()});$("#edit404").click(function(){$.get($("#website_url").val()+"backend/backend_page/edit404page",function(a){a.notFoundUrl?window.location.href=
a.notFoundUrl:smoke.alert($("#edit404-errorMsg").html(),{classname:"errors"})})});$("#cleancache").on("click",function(){$.get($("#website_url").val()+"backend/backend_content/cleancache/",function(a){0==a.error?showMessage(a.responseText,!1,2500):showMessage(a.responseText,!0)})});$("#del-this-page").click(function(){var a=$("#del-page-id").val(),b=$("#website_url").val();0==$(this).data("cid")?$.getJSON(b+"backend/backend_page/checkforsubpages/pid/"+a,function(a){if(a.responseText.subpages)return smoke.alert(a.responseText.message,
{classname:"error"}),!1;showDelConfirm()}):showDelConfirm()})});
