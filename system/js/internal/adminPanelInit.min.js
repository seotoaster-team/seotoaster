...
a.notFoundUrl:smoke.alert($("#edit404-errorMsg").html(),{classname:"errors"})})});$("#del-this-page").click(function(){var a=$("#del-page-id").val(),b=$("#website_url").val();0==$(this).data("cid")?$.getJSON(b+"backend/backend_page/checkforsubpages/pid/"+a,function(a){if(a.responseText.subpages)return smoke.alert(a.responseText.message,{classname:"error"}),!1;showDelConfirm()}):showDelConfirm()})});
