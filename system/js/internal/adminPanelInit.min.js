...
function(a){},{classname:"warning"}),!1;showDelConfirm()}):showDelConfirm()});$("#search-reindex").on("click",function(){$.ajax({url:$("#website_url").val()+"api/toaster/searchreindex/",method:"POST",data:JSON.stringify({}),dataType:"json",beforeSend:function(){smoke.signal("Indexing...")},success:function(a){console.log(a);hideSpinner();a.error?smoke.alert(a.responseText):showMessage("Reindexed "+a.responseText.totalPages+" pages",!1,2500)},error:function(a){console.error(a)}})})});
