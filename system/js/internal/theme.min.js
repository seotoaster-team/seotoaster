...
$("#listpages").show("slide",{direction:"right"})}).on("click",".closebutton .hide, .show~#frm_template",function(a){$("#templatelist, #listpages").hide("slide",{direction:"right"});return!1});$(document).on("click","#listtemplates-btn",function(a){a.preventDefault();a=$("#templatelist");a.show("slide",{direction:"right"}).find(".content").accordion("refresh");a.find(".template_group").css({"max-height":a.height()-a.find(".header").outerHeight(!0)-(a.find(".content").outerHeight(!0)-a.find(".content").height())-
a.find(".template_header:last").outerHeight(!0)*a.find(".template_header").length})});$("textarea").on("keydown",function(a){a.ctrlKey&&83==a.keyCode&&(a.preventDefault(),saveTemplate())})});
