...
function saveTemplate(){var c=editor.getSession().getValue();$.ajax({url:$(this).attr("action"),type:"post",dataType:"json",data:{content:c,pageId:$("#pageId").val(),templateType:$("#template-type").val(),name:$("#title").val(),id:$("#template_id").val(),secureToken:$(this).find("input[name=secureToken]").val()},beforeSend:function(){showSpinner()},success:function(b){hideSpinner();b.error?"string"===typeof b.responseText?showMessage(b.responseText,!0):showMessage(b.responseText.join(". "),!0):(showMessage("Template saved"),
