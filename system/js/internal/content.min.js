$(function(){$("#tabs").tabs();$("#tabs ul").removeClass("ui-corner-all").addClass("ui-corner-top");$(document).one("click",'a[href="#tabs-frag-2"]',function(){$("#tabs-frag-2").empty().load($("#website_url").val()+"backend/backend_content/loadwidgetmaker/")});$(document).on("click","a.ui-tabs-anchor",function(){var a=$(this).find("#products, #news");console.log(a.length);a.length?($(".above-editor-links").removeClass("grid_8").addClass("grid_4"),$("#tabs").removeClass("grid_4").addClass("grid_8"),
