...
($(".mce-toolbar-grp").show(),$(".above-editor-links").removeClass("grid_4").addClass("grid_8"),$("#tabs").removeClass("grid_8").addClass("grid_4"))});$(document).on("click",'[aria-label="Fullscreen"]',function(){$(window.parent.document).find('[aria-describedby="toasterPopup"]').toggleClass("screen-expand");var a=$("#tabs"),d=a.height(),c=a.find(".ui-tabs-nav").height(),b=a.find("#adminthingsviewer .ui-accordion-header"),e=b.length,b=b.outerHeight(),f=a.find("#adminselectimgfolder").outerHeight(),
g=a.find("#btn-create").outerHeight(),h=a.find("#widgetSync").outerHeight()+5;a.find("#adminthingsviewer .ui-accordion-content").css({"max-height":d-c-(b+2)*e-f-30});a.find("#product-products").css({height:d-c-g-116});a.find(".netcontent-widget-list").css({height:d-c-h-12})});$("#btn-submit").click(function(){$("#frm_content").submit()});$("#frm_content").submit(function(){var a={content:$(this).find("#content").val(),containerType:$(this).find("#container_type").val(),containerName:$(this).find("#container_name").val(),
