...
"backend/backend_content/loadwidgetmaker",type:"post",dataType:"json",success:function(b){a.html(b.responseText)},error:function(){a.html('<h4 style="text-align: center;">Unable to load widget maker.</h4>')}})});var b=localStorage.getItem(generateStorageKey()),e=$(this).find("#content").val();null!==b&&b!=e&&showConfirm("We have found content that has not been saved! Restore?",function(){tinymce.activeEditor.setContent(b);$("#content").val(b)},function(){localStorage.removeItem(generateStorageKey())},
"success")});function dispatchEditorKeyup(b,e,a){var c=a;null===c&&(c=setTimeout(function(){localStorage.setItem(generateStorageKey(),tinymce.activeEditor.getContent());c=null},1E3))}function insertFileLink(b){tinymce.activeEditor.execCommand("mceInsertContent",!1,'<a href="'+$("#website_url").val()+"media/"+$("#adminselectimgfolder").val()+"/"+b+'" title="'+b+'">'+b+"</a>")};
