...
type:"POST",dataType:"json",data:{content:b,wordCount:a,pageId:$(document).find("#container-ai-page-id").val(),secureToken:$(document).find("#container-secure-token").val()}}).done(function(a){hideSpinner();if(1===parseInt(a.error))return showMessage(a.message,!0,3E3),!1;tinymce.activeEditor.setContent(a.message);$(document).find("#content").val(a.message)})})});
function dispatchEditorKeyup(c,d,a){var b=a;null===b&&(b=setTimeout(function(){localStorage.setItem(generateStorageKey(),tinymce.activeEditor.getContent());b=null},1E3))}function insertFileLink(c,d){var a="";"undefined"!==typeof d&&(a=d);tinymce.activeEditor.execCommand("mceInsertContent",!1,'<a href="'+$("#website_url").val()+"media/"+$("#adminselectimgfolder").val()+"/"+c+'" title="'+a+'">'+c+"</a>")};
