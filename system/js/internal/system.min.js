...
$(".show-right").hide("slide",{direction:"right"});return!1});$(document).ajaxStop(function(){hideSpinner();checkboxRadioStyle()});a=$(this).find(".show-more-close");0<a.length&&(a.addClass("text-close").hide(),$(".show-more").on("click",function(a){a.preventDefault();a=$(this).closest(".show-more-content").find(".show-more-close");a.hasClass("text-close")?a.removeClass("text-close").addClass("text-open").show():a.removeClass("text-open").addClass("text-close").hide()}))});
