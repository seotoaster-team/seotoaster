...
var b=$(this).closest(".show-more-content").find(".show-more-widget-button-show");a.hide();b.show()}))});$(document).on("click",".screen-size",function(a){a.preventDefault();a=$(this).data("size");$(".closebutton").toggle();$(this).hasClass("open")||$(this).addClass("open");var b=$(".screen-size");$.each(b,function(a,b){$(b).hasClass("open")?$(b).removeClass("open").toggleClass("ticon-expand ticon-turn"):$(b).toggle()});$("body, #"+a+", ."+a).toggleClass("full-screen")});
