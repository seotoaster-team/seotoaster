$(function(){var a=decodeURI(window.location.href);if(a&&"undefined"!=typeof a){var b=$("a[href='"+a+"']");b.addClass("current");b.closest(".page").length&&b.closest(".category").addClass("current");a==$("#website_url").val()&&$("a[href='"+$("#website_url").val()+"index.html']").addClass("current")}$(document).on("click","a.tpopup",function(a){if(loginCheck()){$(".__tpopup").dialog("close");a.preventDefault();var c=$(this);a=c.data("pwidth")||960;var e=c.data("pheight")||560,b=$(document.createElement("iframe")).attr({scrolling:"no",
