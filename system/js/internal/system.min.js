...
$("#trigger-msg").val(c);g.dialog({modal:!0,title:f,width:600,resizable:!1,show:"clip",hide:"clip",draggable:!1,buttons:[{text:d,click:function(a){g.dialog("close");b($("#trigger-msg").val(),$("#additional-emails").val())}}]})},"json")};
