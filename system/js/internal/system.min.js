...
"Click to edit static header");break;default:return!1}var g;$.get(d+"api/toaster/containers/",f,function(f){"undefined"!==typeof f&&(0<f[a].length?e.data({url:d+"backend/backend_content/edit/name/"+a+"/containerType/"+b+"/pageId/"+c}):e.data({url:d+"backend/backend_content/add/containerType/"+b+"/containerName/"+a+"/pageId/"+c}),g=$(f[a]).append(e))},"json");return g};
