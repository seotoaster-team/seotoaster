...
function showConfirm(a,b,d){smoke.confirm(a,function(a){a?"undefined"!=typeof b&&b():"undefined"!=typeof d&&d()},{classname:"error",ok:"Yes",cancel:"No"})}function showSpinner(a){$("undefined"!==typeof a?a:"body>.seotoaster").append('<span class="spinner"></span>')}function hideSpinner(){$(".spinner").remove()}
function showLoader(a){$(document.activeElement).addClass("btn-load").attr("disabled","true");a="undefined"===typeof a?"Loading...":a;$("body").append('<div class="seotoaster-loader">'+a+"</div>")}function hideLoader(a){$(".btn-load").removeClass("btn-load").removeAttr("disabled","false");$(".seotoaster-loader").remove()}function publishPages(){top.$("#__tpopup").length||$.get($("#website_url").val()+"backend/backend_page/publishpages/")}
