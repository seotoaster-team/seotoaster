...
$("#website_url").val()+"index.html']"),a.addClass("current"),0<a.closest("li").length&&a.closest("li").addClass("category-current"))}$(document).on("click","a.tpopup",function(a){if(loginCheck()){$(".__tpopup").dialog("close");a.preventDefault();var b=$(this);a=b.data("pwidth")||960;var c=b.data("pheight")||560,f=$(this).closest("ul"),e="toasterPopupDraggable";f.length&&(e="toasterPopup");var k=$(document.createElement("iframe")).attr({scrolling:"no",frameborder:"no",allowTransparency:"allowTransparency",
id:e}).addClass("__tpopup");k.parent().css({background:"none"});k.dialog({width:a,height:c,resizable:!1,draggable:!0,modal:!0,open:function(){this.onload=function(){$(this).contents().find(".close, .save-and-close").on("click",function(){var a=$("#"+e).prop("src");null!==localStorage.getItem(generateStorageKey())&&-1==$.inArray("uploadthings",a.split("/"))?showConfirm("Hey, you did not save your work? Are you sure you want discard all changes?",function(){localStorage.removeItem(generateStorageKey());
closePopup(k)}):closePopup(k)})};$(this).attr("src",b.data("url")).css({width:"100%",height:"100%",padding:"0px",margin:"0px",overflow:"hidden"});f.length&&$('[aria-describedby="'+e+'"] .ui-dialog-titlebar').remove()},close:function(){$(this).remove()}}).parent().css({height:c+"px"})}});$(document).on("click","a._tdelete",function(){var a=this,b=$(this).attr("href"),c=$(this).data("callback"),f=$(this).data("eid"),e=$(this).data("ignore-custom-message"),k=$("#custom-delete-message").val(),l="You are about to remove an item. Are you sure?";
