...
$(document).on("click",'[name="useImage"]:checkbox',function(){$(this).closest("form").find(".cropped-img").fadeToggle()});$(document).on("click",".cropped-img input:checkbox",function(){$(this).closest("form").find(".crop-size").fadeToggle()});$(document).on("click",".tabs-nav-wrap .arrow",function(){var a=$(this).nextAll(".ui-tabs-nav"),e=a.scrollLeft();$(this).hasClass("left")?a.stop().animate({scrollLeft:e-200}):$(this).hasClass("right")&&a.stop().animate({scrollLeft:e+200})});
