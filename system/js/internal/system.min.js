...
$(document).on("mouseup",".sneak-peek",function(a){$(a.currentTarget).length&&$(a.currentTarget).closest(".sneak-peek-eye").find("input:password").prop("type","password").focus()});
