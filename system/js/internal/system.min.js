...
b+"]").val(a.responseText.data[b]),"password"==b&&$("[name="+b+"]").val("")})});jQuery.fancybox&&$("a._lbox").fancybox({transitionIn:"none",transitionOut:"none",titlePosition:"over"});checkboxRadio();doc.on("click",".closebutton .hide",function(){$(".show-left.show, .show-right.show").removeClass("show");return!1})});
...
function showTooltip(a,d,b){$(a+"[title]").tooltip();switch(b){case "right":$(a+"[title]").tooltip("option",{tooltipClass:d,position:{my:"left+10 center",at:"right center",using:function(a,b){$(this).css(a);$("<span>").addClass("arrow").addClass(b.vertical).addClass(b.horizontal).appendTo(this)}}});break;case "left":$(a+"[title]").tooltip("option",{tooltipClass:d,position:{my:"right-10 center",at:"left center",using:function(a,b){$(this).css(a);$("<span>").addClass("arrow").addClass(b.vertical).addClass(b.horizontal).appendTo(this)}}});
break;case "top":$(a+"[title]").tooltip("option",{tooltipClass:d,position:{my:"center bottom-10",at:"center top",using:function(a,b){$(this).css(a);$("<span>").addClass("arrow").addClass(b.vertical).addClass(b.horizontal).appendTo(this)}}});break;case "bottom":$(a+"[title]").tooltip("option",{tooltipClass:d,position:{my:"center top+10",at:"center bottom",using:function(a,b){$(this).css(a);$("<span>").addClass("arrow").addClass(b.vertical).addClass(b.horizontal).appendTo(this)}}})}}
doc.on("click",'[name="useImage"]',function(){$(this).closest("form").find(".cropped-img").fadeToggle()});doc.on("click",".tabs-nav-wrap .arrow",function(){var a=$(this).nextAll(".ui-tabs-nav"),d=a.scrollLeft();$(this).hasClass("left")?a.animate({scrollLeft:d-200}):$(this).hasClass("right")&&a.animate({scrollLeft:d+200})});
