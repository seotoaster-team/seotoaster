...
".closebutton .hide-block",function(){$(".show-left").hide("slide",{direction:"left"});$(".show-right").hide("slide",{direction:"right"});return!1});$(document).ajaxStop(function(){hideSpinner();checkboxRadioStyle()});a=$(this).find(".show-more-widget-close");0<a.length&&(a.addClass("text-close").hide(),$(".show-more-widget-button-show").on("click",function(a){a.preventDefault();$(this).closest(".show-more-content").find(".show-more-widget-close").show();$(this).hide()}),$(".show-more-widget-button-less").on("click",
function(a){a.preventDefault();a=$(this).closest(".show-more-content").find(".show-more-widget-close");var b=$(this).closest(".show-more-content").find(".show-more-widget-button-show");a.hide();b.show()}))});$(document).on("click",".screen-size",function(a){a=$(this).data("size");$(".closebutton").toggle();$(this).toggleClass("ticon-expand ticon-turn");$("body, #"+a+", ."+a).toggleClass("full-screen")});
