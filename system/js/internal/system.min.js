...
function showTooltip(a,b,d){$(a+"[title]").tooltip();var c="",e="";switch(d){case "right":c="left+10 center";e="right center";break;case "left":c="right-10 center";e="left center";break;case "top":c="center bottom-10";e="center top";break;case "bottom":c="center top+10",e="center bottom"}$(a+"[title]").tooltip("option",{tooltipClass:b,position:{my:c,at:e,using:function(a,b){$(this).css(a);$("<span>").addClass("arrow").addClass(b.vertical).addClass(b.horizontal).appendTo(this)}}})}
$(document).on("click",'[name="useImage"]:checkbox',function(){var a=$(this).closest("form"),b=a.find(".cropped-img");b.fadeToggle(function(){b.is(":visible")||(b.find("input:checkbox").prop("checked",!1),a.find(".crop-size").fadeToggle())})});$(document).on("click",".cropped-img input:checkbox",function(){$(this).closest("form").find(".crop-size").fadeToggle()});
...
function checkboxRadioStyle(){$(".seotoaster").length&&!$(".ie8").length&&$("input:checkbox, input:radio",".seotoaster").not(".processed, .icon, .hidden").each(function(){var a=$(this).prop("id");a.length||(a="chr-"+Math.floor(100*Math.random()+1),$(this).prop("id",a));$(this).is(":radio")?$(this).addClass("radio-upgrade filed-upgrade"):$(this).addClass("checkbox-upgrade filed-upgrade");if(!$(this).closest(".btn-set").length){var b=$(this).parent("label");b.length?(b.prop("for",a),$(this).hasClass("switcher")?
