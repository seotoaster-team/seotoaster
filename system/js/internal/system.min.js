...
function showSpinner(a,b,c){a="undefined"!==typeof a&&"string"===typeof a?a:"body>.seotoaster";"undefined"!==typeof b&&"string"===typeof b?"undefined"!==typeof c?$(a).append('<div class="'+b+' system-spinner-block"><div class="system-spinner system-spinner-with-text"><p>'+c+"</p></div></div>"):$(a).append('<span class="'+b+'"></span>'):$(a).append('<span class="spinner"></span>')}function hideSpinner(a){"undefined"!==typeof a&&"string"===typeof a?$(a).remove():$(".spinner").remove()}
