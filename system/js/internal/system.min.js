...
function showMailMessageEdit(a,b,c){$.getJSON($("#website_url").val()+"backend/backend_config/mailmessage/",{trigger:a,recipient:c},function(a){$(g).remove();var c=a.responseText.message,f=a.responseText.dialogTitle,e=a.responseText.dialogOkay,f=0<f.length?f:"Edit mail message before sending",e=0<e.length?e:"Okay",c=c?a.responseText.message:"success",g=$('<div class="msg-edit-screen"></div>').append($('<textarea id="trigger-msg" rows="10"></textarea>').val(c).css({resizable:"none"}));$(g).append('<div class="mt10px"><label> Additional emails <a href="javascript:;" class="ticon-info tooltip icon18" title="You can enter emails separated by comma. ex: John@mail.com,Doe@mail.com"></a> : </label><input type="text" name="additional-emails" id="additional-emails" value="" /></div>');
$("#trigger-msg").val(c);g.dialog({modal:!0,title:f,width:600,resizable:!1,show:"clip",hide:"clip",draggable:!1,buttons:[{text:e,click:function(a){a=$("#additional-emails").val();var c=!0;if(a.length){a=a.split(",");var e=/^(([^<>()\[\]\\.,;:\s@"]+(\.[^<>()\[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/;$.each(a,function(a,b){var d=b.toString().replace(/\s/g,"");e.test(d)||(c=!1,showMessage("Not valid "+d+" email address",!0,3E3))})}c&&
(g.dialog("close"),b($("#trigger-msg").val(),$("#additional-emails").val()))}}],close:function(a,b){$(this).dialog("close").remove()}})},"json")};
