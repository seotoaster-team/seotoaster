...
$(document).on("click",".screen-size",function(a){a=$(this).data("size");$(".closebutton").toggleClass("hidden");$(this).toggleClass("icon-expand icon-turn");$("body, #"+a+", ."+a).toggleClass("full-screen")});
