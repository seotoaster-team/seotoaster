...
$("#website_url").val()+"index.html']"),a.addClass("current"),0<a.closest("li").length&&a.closest("li").addClass("category-current"))}$(document).on("click","a.tpopup",function(a){if(loginCheck()){$(".__tpopup").dialog("close");a.preventDefault();var b=$(this);a=b.data("pwidth")||960;var c=b.data("pheight")||560,f=$(this).closest("ul"),e="toasterPopupDraggable";f.length&&(e="toasterPopup");var l=!1;$(this).hasClass("edit-product-btn")&&(l=!0);var k=$(document.createElement("iframe")).attr({scrolling:"no",
frameborder:"no",allowTransparency:"allowTransparency",id:e}).addClass("__tpopup");k.parent().css({background:"none"});k.dialog({width:a,height:c,resizable:!1,draggable:!0,modal:!0,open:function(){this.onload=function(){$(this).contents().find(".close, .save-and-close").on("click",function(){var a=$("#"+e).prop("src");null!==localStorage.getItem(generateStorageKey())&&-1==$.inArray("uploadthings",a.split("/"))?showConfirm("Hey, you did not save your work? Are you sure you want discard all changes?",
function(){localStorage.removeItem(generateStorageKey());closePopup(k)}):closePopup(k)})};$(this).attr("src",b.data("url")).css({width:"100%",height:"100%",padding:"0px",margin:"0px",overflow:"hidden"});(f.length||l)&&$('[aria-describedby="'+e+'"] .ui-dialog-titlebar').remove()},close:function(){$(this).remove()}}).parent().css({height:c+"px"})}});$(document).on("click","a._tdelete",function(){var a=this,b=$(this).attr("href"),c=$(this).data("callback"),f=$(this).data("eid"),e=$(this).data("ignore-custom-message"),
l=$("#custom-delete-message").val(),k="You are about to remove an item. Are you sure?";"undefined"!=typeof b&&b&&"javascript:;"!=b||(b=$(this).data("url"));l&&!e&&(k=l);smoke.confirm(k,function(e){e?$.ajax({url:b+"id/"+f,type:"DELETE",dataType:"json",beforeSend:showSpinner(a),success:function(a){var b=a.hasOwnProperty(b)?a.responseText:"Removed.",d;"undefined"!==typeof a.responseText.userDeleteError&&(b=a.responseText.userDeleteError.quote,d=2E3);showMessage(b,!("undefined"==typeof a.error||!a.error),
3E3);"undefined"!=typeof c&&eval(c+"("+d+")");hideSpinner()}}):$(".smoke-base").remove()},{classname:"error",ok:"Yes",cancel:"No"})});$(document).on("submit","form._fajax",function(a){a.preventDefault();var b=$(this),c=$(b).data("callback"),f=$(b).data("dialog-box"),e=$(b).data("dialog-box-callback");$.ajax({url:b.attr("action"),type:"post",dataType:"json",data:b.serialize(),beforeSend:showSpinner(),success:function(a){a.error?(hideSpinner(),"object"===typeof a.responseText?($.each(a.responseText,
function(a,c){var d=b.find('[name="'+a+'"]');d.addClass("notvalid");d.is(":checkbox")||d.is(":radio")||d.is(":hidden")?d.parent().is("label")?d.parent().prop("title",c).addClass("notvalid"):(d=d.prop("id"),$(document).find('[for="'+d+'"]').prop("title",c).addClass("notvalid")):d.prop("title",c)}),$(".notvalid").on("change",function(){var a=$(this);if(a.is(":checkbox")||a.is(":radio")||a.is(":hidden"))if(a.parent().is("label"))a.parent().tooltip("destroy").removeAttr("title","").removeClass("notvalid");
else{var b=a.prop("id");$(document).find('[for="'+b+'"]').tooltip("destroy").removeAttr("title","").removeClass("notvalid")}else a.tooltip("destroy").removeClass("notvalid").removeAttr("title");a.unbind()}),showTooltip(".notvalid","error","right")):f&&e&&a.dialog?smoke.confirm(a.responseText,function(a){a&&"undefined"!=typeof e&&null!=e&&eval(e+"()")},{ok:"Yes",cancel:"No",reverseButtons:!0}):smoke.alert(a.responseText,function(){"undefined"!=typeof c&&null!=c&&eval(c+"()")},{classname:"error"})):
b.hasClass("_reload")?"undefined"!=typeof a.responseText.redirectTo?top.location.href=$("#website_url").val()+a.responseText.redirectTo:top.location.reload():("undefined"!=typeof c&&null!=c&&eval(c+"()"),hideSpinner(),showMessage(a.responseText))},error:function(a){$(".smoke-base").remove();showMessage("Oops! sorry but something fishy is going on - try again or call for support.",!0)}})});$(document).on("click","a._tedit",function(a){a.preventDefault();a=$(this).data("url");var b=$(this).data("callback");
a&&"undefined"!=a||(a=$(this).attr("href"));var c=$(this).data("eid");$.post(a,{id:c},function(a){$("#"+a.responseText.formId);for(var c in a.responseText.data)$("[name="+c+"]").length&&$("[name="+c+"]").is(":checkbox")?"1"==a.responseText.data[c]?$("[name="+c+"]").prop("checked",!0):$("[name="+c+"]").prop("checked",!1):$("[name="+c+"]").val(a.responseText.data[c]),"password"==c&&$("[name="+c+"]").attr("placeholder","********").val(""),"attributes"==c&&$.each(a.responseText.data[c],function(a,b){$("#user-attributes-section").append('<div class="grid_6"><input type="text" class="user-custom-attribute-name" name="attrName[]" value="'+
a+'"></div><div class="grid_6"><input type="text" name="attrValue[]" value="'+b+'"></div>')});"undefined"!=typeof b&&null!=b&&eval(b+"()")})});jQuery.magnificPopup&&($("._lbox").magnificPopup({type:"image"}),$(".img_gallery").each(function(){$(this).magnificPopup({delegate:"a.gall",type:"image",gallery:{enabled:!0}})}));checkboxRadioStyle();$(document).on("mouseup",".seotoaster",function(a){0===$(".show-left, .show-right").has(a.target).length&&($(".show-left").hide("slide",{direction:"left"}),$(".show-right").hide("slide",
{direction:"right"}))}).on("click",".closebutton .hide-block",function(){$(".show-left").hide("slide",{direction:"left"});$(".show-right").hide("slide",{direction:"right"});return!1});$(document).ajaxStop(function(){hideSpinner();checkboxRadioStyle()});a=$(this).find(".show-more-widget-close");0<a.length&&(a.addClass("text-close").hide(),$(".show-more-widget-button-show").on("click",function(a){a.preventDefault();$(this).closest(".show-more-content").find(".show-more-widget-close").show();$(this).hide()}),
$(".show-more-widget-button-less").on("click",function(a){a.preventDefault();a=$(this).closest(".show-more-content").find(".show-more-widget-close");var b=$(this).closest(".show-more-content").find(".show-more-widget-button-show");a.hide();b.show()}))});
...
$(document).on("change","#reply-email",function(a){a.currentTarget.checked?$(".reply-info").hide():$(".reply-info").show()});
$(document).on("click","#screen-expand",function(a){$(this).toggleClass("ticon-expand ticon-turn");a=$(window.parent.document).find('[aria-describedby="toasterPopup"]');a.length||(a=$(window.parent.document).find('[aria-describedby="toasterPopupDraggable"]'));a.toggleClass("screen-expand");$(".content").toggleClass("screen-expand");a=a.height();$("#edittemplate").length?$(".ace_editor").height(a-170):$(".ace_editor").height(a-110);editor.resize()});
