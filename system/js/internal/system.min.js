...
function addGeneralLinks(a,b){var d=$("#website_url").val(),c=$("#page_id").val(),f=window.location.href.replace(d,""),e=$('<a class="tpopup generator-links" data-pwidth="960" href="javascript:;"></a>'),f={page:f,pid:c,type:b,name:a,action:"index",controller:"index",co:"index"};switch(b){case 1:e.append('<img width="26" height="26" src="'+d+'system/images/editadd-content.png" alt="edit content"/>').data({pheight:560,pwidth:960}).attr("title","Click to edit content");break;case 2:e.append('<img width="26" height="26" src="'+
d+'system/images/editadd-static-content.png" alt="edit static content"/>').data({pheight:560,pwidth:960}).attr("title","Click to edit static content");break;case 3:e.append('<img width="26" height="26" src="'+d+'system/images/editadd-header.png" alt="edit header"/>').data({pheight:140,pwidth:600}).attr("title","Click to edit header");break;case 4:e.append('<img width="26" height="26" src="'+d+'system/images/editadd-static-header.png" alt="edit static header"/>').data({pheight:140,pwidth:600}).attr("title",
"Click to edit static header");break;default:return!1}$.get(d+"api/toaster/containers/",f,function(f){var g=$(".ajax-test");g.empty();"undefined"!==typeof f&&(0<f[a].length?e.data({url:d+"backend/backend_content/edit/name/"+a+"/containerType/"+b+"/pageId/"+c}):e.data({url:d+"backend/backend_content/add/containerType/"+b+"/containerName/"+a+"/pageId/"+c}),g.html(f[a]).append(e))},"json")};
