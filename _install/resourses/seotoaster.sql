...
INSERT INTO `plugin` (`id`, `name`, `status`, `tags`, `license`) VALUES
(1, 'netcontent', 'enabled', NULL, ''),
(2, 'api', 'enabled', NULL, ''),
(3, 'widcard', 'enabled', NULL, '');
...
ALTER TABLE `container`
  ADD CONSTRAINT `container_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `seotoaster2`.`page` (`id`) ON DELETE CASCADE ON UPDATE NO ACTION;

--
-- Constraints for table `deeplink`
--
ALTER TABLE `deeplink`
  ADD CONSTRAINT `deeplink_ibfk_1` FOREIGN KEY (`page_id`) REFERENCES `seotoaster2`.`page` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `page_fa`
  ADD CONSTRAINT `page_fa_ibfk_1` FOREIGN KEY (`fa_id`) REFERENCES `seotoaster2`.`featured_area` (`id`) ON DELETE CASCADE,
...
ALTER TABLE `template`
  ADD CONSTRAINT `template_ibfk_1` FOREIGN KEY (`type`) REFERENCES `seotoaster2`.`template_type` (`id`) ON DELETE CASCADE;
